    ...
    if response.status_code == 200:
        ...
        if 'Ваша электронная почта' in response.text:
            ...
            if 'Ваш код выслан на почту' in response.text:
                ...
                print('⚠️ \033[1;31mУказанная почта не подходит для получения тестового периода.\033[0m Подробнее о данной ошибке вы можете узнать на странице: https://zsay.ru/hidemy-name/#print')
        else:
